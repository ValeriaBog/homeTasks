...
function Clock() {
    ...
    const stringTime = new Intl.DateTimeFormat("ru", { //время
        hour: "numeric",
        minute: "numeric",
        second: "numeric"
    ...
    const stringDay = new Intl.DateTimeFormat("en", {weekday: "long",}).format(date) || <br/> // пишут студенты // день недели
    const stringMonth = new Intl.DateTimeFormat("en", {month: "long",}).format(date)
        || <br/> // пишут студенты //месяц
